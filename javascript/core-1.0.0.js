...
define('core/lib/handlebars_helpers',['handlebars', 'core/lib/handlebars/form', 'core/lib/handlebars/commons', 'core/session'], function() {
  ...
  return Handlebars.registerHelper('loadTemplate', function(options) {
